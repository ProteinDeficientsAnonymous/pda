...
from users._dev_tools import router as dev_tools_router
...
from users._magic_login import router as magic_login_router
...
router.add_router("", magic_login_router)
