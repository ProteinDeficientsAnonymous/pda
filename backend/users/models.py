...
class User(AbstractUser):
    ...
    veganversary_month = models.PositiveSmallIntegerField(null=True, blank=True)
    veganversary_day = models.PositiveSmallIntegerField(null=True, blank=True)
    veganversary_year = models.PositiveSmallIntegerField(null=True, blank=True)
    show_veganversary = models.BooleanField(default=True)
    veganversary_shoutout_opt_out = models.BooleanField(default=False)
