...
RUN flutter build web --release --pwa-strategy=none --dart-define=API_URL= --dart-define=GIT_SHA=${RAILWAY_GIT_COMMIT_SHA} --dart-define=ENABLE_FEEDBACK=${ENABLE_FEEDBACK} --no-pub --no-wasm-dry-run
