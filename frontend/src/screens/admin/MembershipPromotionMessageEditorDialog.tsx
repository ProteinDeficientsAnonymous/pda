  ...
  return (
    <form onSubmit={(e) => void onSubmit(e)} className="flex flex-col gap-3">
      ...
      <textarea
        ...
        rows={10}
        className="border-border bg-background text-foreground focus-visible:ring-brand-200 w-full rounded-md border p-3 font-mono text-sm focus-visible:outline-none"
