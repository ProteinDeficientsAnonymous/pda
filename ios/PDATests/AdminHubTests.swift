...
final class AdminHubTests: XCTestCase {
    func test_noAdminPermission_hidesHub() throws {
        ...
        XCTAssertFalse(hasAnyAdminPermission(try user(permissions: ["edit_faq", "manage_surveys", "manage_feature_flags"])))
    ...
    func test_defaultAdminRole_showsSubsetTiles() throws {
        ...
        XCTAssertEqual(
            ...
            ["members", "join requests", "events", "flagged events", "attendance", "join form", "docs"]
        )
